  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mx-auto max-w-3xl rounded-[32px] border border-white/15 bg-white/10 px-8 py-10 text-center shadow-[0_0_80px_rgba(56,189,248,0.08)] backdrop-blur-xl"
      >
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <a href="/resume.pdf" className="rounded-full border border-cyan-400/40 bg-cyan-400/10 px-6 py-3 text-sm font-semibold text-cyan-200 transition hover:bg-cyan-400/20" download>
            Download Resume
          </a>
          <a href="https://github.com/shaikhumza" target="_blank" rel="noreferrer" className="rounded-full border border-white/15 bg-white/10 px-6 py-3 text-sm font-semibold text-slate-100 transition hover:bg-white/20">
            View GitHub
          </a>
        </div>
      </motion.div>
